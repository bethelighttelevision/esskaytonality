        ...
        >
             ...
             <div className="relative w-24 h-24 flex items-center justify-center">
               ...
               <div className="absolute inset-0 rounded-full bg-brand-accent/20 border border-brand-accent/30 animate-ripple-delay-1 pointer-events-none" />
                  ...
                  <motion.div 
                   ...
                   className="relative z-10 w-24 h-24 rounded-full bg-black/40 border border-white/20 flex items-center justify-center group-hover:border-brand-primary transition-colors"
                  >
          ...
          <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full flex justify-between items-end z-20">
            <div>
              ...
              <h2 className="text-4xl md:text-6xl font-bold text-white uppercase tracking-tighter drop-shadow-lg">{featuredVideo.title}</h2>
            </div>
            <span className="bg-black/80 px-4 py-2 rounded font-mono text-sm border border-white/10">
            ...
            <div className="relative aspect-video rounded-xl overflow-hidden mb-4 border border-white/5 bg-black">
              ...
              <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-colors flex items-center justify-center">
                <div className="relative w-16 h-16 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  ...
                  <div className="relative z-10 w-16 h-16 rounded-full bg-black/50 flex items-center justify-center border border-white/10">
                    <PlayCircle className="w-8 h-8 text-white" />
                  </div>
                </div>
              </div>
              <span className="absolute bottom-4 right-4 bg-black/80 px-2 py-1 rounded font-mono text-xs border border-white/10">
                {video.duration}
              </span>
            </div>
        ...
        {activeVideo && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-4xl aspect-video rounded-2xl overflow-hidden bg-brand-card border border-brand-border"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close Button */}
              <button 
                onClick={() => setActiveVideo(null)}
                className="absolute top-4 right-4 z-10 w-10 h-10 rounded-full bg-brand-card border border-brand-border text-white/70 hover:text-white flex items-center justify-center hover:bg-white/10 transition-all"
              >
                <X className="w-5 h-5" />
              </button>
