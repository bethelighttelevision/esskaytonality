...
export default function SignedArtistDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    if (typeof window !== "undefined") {
      ...
      const initPlayer = () => {
        ...
        if (YT && YT.Player) {
          ...
          ytPlayerRef.current = new YT.Player('hidden-youtube-audio-player-signed', {
            height: '0',
            width: '0',
            videoId: '',
            playerVars: {
  ...
  return (
    <div className="w-full min-h-screen pb-24">
      <div id="hidden-youtube-audio-player-signed" className="pointer-events-none absolute w-0 h-0 opacity-0" />
