          ...
          <AnimatePresence mode="wait">
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className="mt-8 mb-8 space-y-3 relative">
                  {error && (
                  ...
                  <div className="absolute inset-0 z-10 flex items-center justify-center bg-black/40 backdrop-blur-[2px] rounded-xl mt-0">
                    <span className="text-xs font-bold tracking-widest text-white uppercase bg-black/80 px-3 py-1 rounded-full border border-white/20 mt-10">Setup Required in Supabase</span>
                  </div>
