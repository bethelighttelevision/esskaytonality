      ...
      >
        <div className="bg-brand-card border border-brand-border p-8 md:p-10 rounded-xl relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-brand-muted-dark text-sm">Sign in to access your dashboard.</p>
          </div>
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="text-xs font-bold tracking-widest text-brand-muted-dark uppercase">Or email</span>
            <div className="h-px bg-white/10 flex-1" />
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-brand-bg border border-brand-border rounded-lg px-4 py-3 pl-12 pr-4 text-white placeholder:text-brand-muted focus:outline-none focus:border-brand-primary/50 focus:ring-1 focus:ring-brand-primary/50 transition-all"
            ...
            <div className="flex items-center justify-between mt-2 mb-6">
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <span className="text-xs text-brand-muted-dark">Remember me</span>
              </label>
